...
C*****  NOTE: RURAL and URBAN have been returned to COMMON /CNTLOG/
      ...
      LOGICAL L_FLGDF !P008 WSP 1/18/2024
      
      DOUBLE PRECISION :: ZFLG  !P008 CRT 3/20/2024, user-defined flagpole height
...
C***********************************************************************
     ...
     &               NTTYP(:), ARCID(:), RECNAM(:)
      ...
      DOUBLE PRECISION, ALLOCATABLE :: AX1S(:), AY1S(:)  ! WSP 3/25/2024 P005_P006_P007
      DOUBLE PRECISION, ALLOCATABLE :: AX2S(:), AY2S(:)  ! WSP 3/25/2024 P005_P006_P007
      DOUBLE PRECISION, ALLOCATABLE :: AWS(:)            ! CRT 4/3/2024 P005_P006_P007 - width of line
...
C***********************************************************************
      ...
      DATA VERSN /'24142'/           ! Version date: May 21, 2024
...
CCRT  4/8/2024 P010 - add err messages for RECEPTOR keyword on OU pathway
C     when no receptors defined
      DATA ERRCOD(122 ) /'192'/,
     &ERRMSG(122) /'RECEPTOR keyword spec but no receptors defined.   '/   
      DATA ERRCOD(123 ) /'193'/,
     &ERRMSG(123) /'No RECEPTOR keyword spec w/ EXTRACT option, NREC= '/         
      DATA ERRCOD(124 ) /'194'/,
     &ERRMSG(124) /'Either SOURCLOC or RECEPTOR keyword is required.'/
     ...
     &ERRMSG(117) /'Fatal Error Occurs Opening the Data File          '/
      DATA ERRCOD(118) /'505'/,
     &ERRMSG(118) /'File Already in Use, Cannot be Opened (1st chars:)'/
      DATA ERRCOD(119) /'510'/,
...
CCRT 4/8/2024 P010 - ERRCOD/ERRMSG array indices 122-124 used used out 
C    out of sequence for new messages, above
