...
C*    Variable Declarations
      ...
      LOGICAL GAPREC
      LOGICAL L_Opened ! CFT 4/16/2024 P001 File already in use
...
CCRT     CRT 4/17/2024 P001 - Add check for receptor debug file already opened
         L_Opened = .FALSE.
         INQUIRE(FILE=RECNDEM_FILE, OPENED=L_Opened)
         IF (L_Opened) THEN
