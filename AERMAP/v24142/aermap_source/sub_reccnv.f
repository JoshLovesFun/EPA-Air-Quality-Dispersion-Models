...
C*    Variable Declarations
      ...
      LOGICAL L_Opened  ! CRT 4/15/2024 P001 - check for file already in use

C*    Variable Initializations
      MODNAM = 'RECCNV'

      IF (RECDBG) THEN
CCRT     CRT 4/15/2024 P001 - Add check for receptor debug file already opened
         L_Opened = .FALSE.
         INQUIRE(FILE=RECDET_FILE, OPENED=L_Opened)
         IF (L_Opened) THEN
