...
C*    Variable Declarations
      ...
      LOGICAL L_Opened  ! CRT 4/16/2024 P001 File already in use
...
CCRT        CRT 4/16/2024 P001 - File already in use
C            rewrite to throw error if file already in use
            INQUIRE(UNIT=RELVK, OPENED=L_Opened)
C            IF (.NOT. L_Opened) THEN
            IF (L_Opened) THEN
